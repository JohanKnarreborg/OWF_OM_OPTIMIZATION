...
Thesis repository containing OWF O&M model created by Jonathan Hjortshøj-Nielsen and Johan Østergaard Knarreborg. Thesis describing the work behind this GitHub can be found in the file: Opportunistic_scheduling_of_wind_farm_OM_activities.pdf.
